    ...
    <div className="max-w-2xl mx-auto py-12">
      <div className="text-center mb-10">
        ...
        <p className="text-slate-500 mt-2">
          抽象的な目標から具体的なスキルまで、AIがステップバイステップの道筋を描きます。
        </p>
      </div>

      <form
        onSubmit={handleSubmit}
        className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200 space-y-6"
      >
        <div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-5 bg-white border border-slate-200 rounded-2xl shadow-sm">
          ...
          <p className="text-slate-500 text-xs leading-relaxed">
            語学、芸術、実務スキル、学問など、どんな分野の目標でも構造化します。
          </p>
        </div>
        <div className="p-5 bg-white border border-slate-200 rounded-2xl shadow-sm">
          <h4 className="font-bold text-slate-800 text-sm mb-1">チャットサポート</h4>
          <p className="text-slate-500 text-xs leading-relaxed">
            作成後のカリキュラム各ステップで、AIが専門的な疑問に答えます。
          </p>
        </div>
      </div>
    </div>
